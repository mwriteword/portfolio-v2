          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            <div className="flex-1 min-w-0">
              <div className="space-y-3">
                ...
                <p className="text-base leading-relaxed text-[#ffffff]">When I'm not doing content stuff, I'm a father/butler to two small children for a majority of my time. I enjoy cooking both as a hobby and a survival skill, often cooking with my daughters on the weekend. When I find some free time, I like to enjoy a good couch RPG or a meaty puzzle game I can sink my teeth into.</p>
